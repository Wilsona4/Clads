...
class ClientRepositoryImpl @Inject constructor(
    ...
    override suspend fun addClientToServer(client: Client): Flow<Resource<GenericResponseClass<Client>>> {
    ...
    override suspend fun addClientToDb(client: Client): Resource<Client> {
        ...
        return if (result.data!! > 0) {
            Resource.Success(client,message = "Client added successfully")
        } else {
